...
*                                                                            *
*  Copyright (c) 2004-2017 RealThinClient (http://www.realthinclient.com)    *
...
uses
  SysUtils, Classes, 
  rtcTypes, memPtrPool, rtcSyncObjs;
...
{$ELSE}{$IFDEF CPUX32} // 32-bit version
  {$L zlib\deflate.obj}
  {$L zlib\inflate.obj}
  {$L zlib\infback.obj}
  {$L zlib\inffast.obj}
...
{$ELSE}{$IFDEF CPUX64} // 64-bit version
