...
{$ENDIF}
  ...
  public // WEB SOCKETS
    ...
    { WEB SOCKET:
      ...
      or 0 if this call has failed (not a Web Socket connection or already closed). }
    ...
    { WEB SOCKET:
      ...
      into the sending queue and is now being sent our waiting in the queue.
      Call with "vFinal=TRUE" if this is the final Payload for this Frame.
      Returns TRUE "vPayload" was added to "iFrame", FALSE if this call failed. }
