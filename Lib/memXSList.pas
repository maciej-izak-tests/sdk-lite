{
  "eXtended Pooled List" (RtcString>'')
...
procedure tXSList.extractFirst(var exInfo:infoType);
  var
    x:pnode;
  begin
  if fFirst<>nil then
...
procedure tXSList.extractLast(var exInfo:infoType);
  var
    x:pnode;
  begin
  if fLast<>nil then
